pipeline {
    ...
    environment {
        DOCKERHUB_USERNAME = 'sahanavnaik2210'  // Change if needed
    ...
    parameters {
        ...
        string(name: 'RECEIVER_EMAIL', defaultValue: 'sahanavnaik2210@gmail.com', description: 'Comma-separated recipient emails')
    }
